...
Map<FlashMode, IconData> flashMap = {
...
class CameraIconButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      color:
          selectedFlashMode == flashMode ? Colors.amber.shade200 : Colors.white,
      onPressed: () => flashMode == null ? onPressed() : onPressed(flashMode),
      icon: flashMode == null
          ? const Icon(Icons.cameraswitch)
          : Icon(flashMap[flashMode]),
    );
  }
}
